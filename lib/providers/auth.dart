...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:${urlSegment}?key=AIzaSyC7IpD0DnG9hWxKIHHdwYPM6z04kmdQTIQ';
    try {
  ...
  Future<bool> tryAutoLogin() async {
    ...
    final extractedUserData =
        json.decode(sharedPref.getString('userData') as String)
